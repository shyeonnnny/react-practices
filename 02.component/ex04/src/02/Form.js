...
export default function Form() {
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <fieldset>
                <legend>성별</legend>
                <label>여</label> <input type="radio" name="gender" value={ "female" } onChange={} checked={gender === 'femail'} defaultChecked={ true } />
                <label>남</label> <input type="radio" name="gender" value={ "male" } onChange={} checked={gender === 'male'} defaultChecked={ false } />
            </fieldset>
